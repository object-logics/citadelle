lexicon: "!" "!!" "#" "%" "&" "&&&" "(" "()" "(|" ")" "*" "*⇩R" "+" "++" "," "-"
  ...
  ":" "::" ":=" ":>" ";" "<" "<*>" "<*lex*>" "<*mlex*>" "<+>" "<-" "<->" "<.."
  "<..<" "<..}" "<=" "=" "==" "==>" "=>" "=simp=>" ">" ">=" "?" "?!" "@" "ALL"
  "CHR" "CONST" "CSUM" "DERIV" "EX" "EX!" "FDERIV" "GREATEST" "INF" "INFM" "INT"
  "Int" "LEAST" "LIM" "MOST" "O" "OFCLASS" "OO" "PROD" "PROP" "SIGMA" "SOME"
  ...
  "⌉" "ℝ" "⌋" "⇀" "⦈" "ϵ" "⋄" "⊂" "⊆" "⊆⇩m" "⊃" "⊇" "×" "∪" "]" "^" "^*" "^**"
  "^+" "^++" "^--1" "^-1" "^=" "^==" "^^" "_" "`" "``" "at" "case" "chain⇩⊆"
  "choose" "differentiable" "div" "dvd" "else" "gchoose" "has_derivative"
  "has_field_derivative" "has_real_derivative" "has_vector_derivative" "if" "in"
  "initial_segment_of" "let" "mod" "o" "o_m" "of" "op" "powr" "respects"
...
prods:
  ...
  logic = "⌊" any[0] "⌋" => "\<^const>Archimedean_Field.floor_ceiling_class.floor"
    (1000)
  logic = "⌈" any[0] "⌉" => "\<^const>Archimedean_Field.ceiling" (1000)
...
consts: "\<^const>Filter.Alm_all_binder" "\<^const>Filter.Inf_many_binder"
  ...
  "_cargs" "_case1" "_case2" "_case_syntax" "_class_name" "_classes" "_constify"
  "_constrain" "_constrainAbs" "_context_const" "_context_xconst" "_dummy_ofsort"
  "_eventually" "_field" "_field_type" "_field_types" "_field_update"
  "_field_updates" "_fields" "_filter" "_free" "_frequently" "_from_to_setprod"
  "_from_to_setsum" "_from_upto_setprod" "_from_upto_setsum" "_idtdummy" "_idts"
  "_idtyp" "_idtypdummy" "_ignore_type" "_index" "_indexdefault" "_indexvar"
  "_inner_string" "_lam_pats_syntax" "_lambda" "_lc_abs" "_lc_end" "_lc_gen"
  "_lc_quals" "_lc_test" "_list" "_listcompr" "_listprod" "_listsum" "_loose"
  "_lupdbind" "_lupdbinds" "_maplet" "_maplets" "_mk_ofclass" "_numeral" "_ofclass"
  "_ofsort" "_pattern" "_patterns" "_position" "_position_sort" "_pttrns"
  "_qsetprod" "_qsetsum" "_record" "_record_scheme" "_record_type"
  "_record_type_scheme" "_record_update" "_setleAll" "_setleEx" "_setleEx1"
  "_setlessAll" "_setlessEx" "_setprod" "_setsum" "_sort" "_sort_constraint"
  "_strip_positions" "_struct" "_tapp" "_tappl" "_tfree" "_topsort" "_tuple"
  "_tuple_arg" "_tuple_args" "_tvar" "_type_constraint_" "_type_name" "_type_prop"
  "_types" "_update_name" "_updbind" "_updbinds" "_upt_setprod" "_upt_setsum"
...
parse_translation: "\<^const>Filter.Alm_all_binder"
  ...
  "_TYPEREP" "_abs" "_aprop" "_case_syntax" "_index" "_lam_pats_syntax"
  "_listcompr" "_ofclass" "_record" "_record_scheme" "_record_type"
  "_record_type_scheme" "_record_update" "_sort_constraint" "_struct"
  "_update_name"
print_translation: "\<^const>Complete_Lattices.INTER"
  ...
  "\<^const>Typerep.typerep_class.typerep" "_type_constraint_" "_type_prop"
print_rules:
