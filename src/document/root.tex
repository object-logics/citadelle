...
\begin{abstract}
  ...
  \acs{ocl} in \acf{hol}. It provides denotational definitions, a logical calculus
  ...
  \acs{ocl} standard.  They reflect a challenge to define and implement \OCL tools in a
  uniform manner.
