...
\isatagannexa
  \KOMAoptions{paper=8.28in:11in,twoside=semi}
  \areaset{6.7in}{8in}
...
\setcounter{tocdepth}{2} % printed TOC not too detailed 
\hypersetup{bookmarksdepth=4} % more detailed digital TOC (aka bookmarks)
\sloppy
