...
\publishers{%
  ...
  \href{mailto:"Burkhart Wolff" <burkhart.wolff@lri.fr>}{burkhart.wolff@lri.fr}\\[2em]
  %
...
\begin{abstract}
  ...
  called Object Constraint Language (OCL). OCL is a
  ...
  %Since version 2.3 (released
  The situation complicated when with
