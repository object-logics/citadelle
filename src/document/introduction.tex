...
defined as follows: \fxnote{should we use expliucit definitions ?}
\begin{itemize}
...
superclass. \fxwarning{correct? What should be checked? Achim: Description of Liskov is IMHO correct, 
