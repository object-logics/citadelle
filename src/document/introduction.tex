...
textual annotation language, based on a three-valued logic, that turns
UML into a formal language.  Unfortunately the semantics of this
...
\eg,~\cite{brucker.ea:semantic:2006-b,brucker.ea:proposal:2002,mandel.ea:ocl:1999,hamie.ea:reflections:1998,cook.ea::amsterdam:2002}).
...
For the OCL community, this results in the challenge to define a
...
formal parts of the standards. To discuss the future directions of the
standard, a number of OCL experts decided to meet in November 2013 in
Aachen for two days to discuss possible short term improvements of OCL
for an upcoming OMG meeting and to envision possible future long-term
developments of the
language~\cite{brucker.ea:summary-aachen:2013}. During this meeting,
the Request for Proposals (RFP) for OCL 2.5 was finalized. This RFP,
in particular, demands that the OCL 2.5 standard document shall be
generated from a machine-checked source. This will ensure 
\begin{itemize}
...
Isabelle/HOL~\cite{nipkow.ea:isabelle:2002} of the core language of
OCL, called Featherweight OCL. This formal semantics definition OCL
could, during the standardization process of OCL 2.5, replace the
``Annex A'' of the OCL standard~\cite{omg:ocl:2012}.
