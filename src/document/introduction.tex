...
which were irrelevant for this presentation and are therefore omitted.}
where:
\begin{itemize}
...
\item $TC$ is a set of \emph{type constructors} like "$('\alpha)\operatorname{list}$" or
  ...
  note that the paranthesis' of null-ary type constructors are usually omitted.
\end{itemize}
...
notation (and the convention that free variables are implicitly universally quantified)
...
have a formal semantics, sub-typing becomes an issue of the front-end that can
