...
\end{gather}
/fixme{LaTeX : could we elmiminate the label A 17 which is generated from this ?}
...
a collection not containing $\isasymOclNull$. This allows for a straight-forward 
interpretation of
