...
inductively defined as follows:
 \isatagafp
  \fxnote{should we use explicit definitions?}
 \endisatagafp
\begin{itemize}
...
\end{itemize}
\isatagafp \fxwarning{correct? What should be checked? Achim:
  Description of Liskov is IMHO correct, but the simulation of a
  vtable using oclIsKindOf is at least tedious. One should, imho, add
  a vtable for modelling overridding properly (informally, we had this
  already in HOL-OCL)}
\endisatagafp
