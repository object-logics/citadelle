...
\inputif{Meta_Isabelle.tex}
  \inputif{Meta_Toy.tex}
  \inputif{Meta_Toy_extended.tex}
\inputif{Meta_META.tex}

%\chapter{Toy Libraries Static}
  \inputif{Toy_Library_Static.tex}
...
\inputif{Parser_Pure.tex}
  \inputif{Parser_Toy.tex}
  \inputif{Parser_Toy_extended.tex}
...
\inputif{Printer_Isabelle.tex}
  \inputif{Printer_Toy.tex}
  \inputif{Printer_Toy_extended.tex}
...
Some functions have been generalized for supporting the use of polymorphic cartouches.
...
\chapter{Example Showing One Generated File}
