...
\chapter{Definition of Meta-Models}
\input{Meta_Pure.tex}
%\input{Meta_oid.tex}
\input{Meta_SML.tex}
...
%\input{Printer_oid.tex}
\input{Printer_SML.tex}
\input{Printer_Isabelle.tex}

\part{Part II: Case Study: A Toy Example}
\inputif{Toy_Library.tex}
\inputif{Analysis_shallow.tex}
\inputif{Analysis_deep.tex}
% Analysis Deep can not be included 
\part{Part III: Appendix}
\inputif{Rail.tex}
