...
While these tags might work in Isabelle/Isar 

  text {* ... *}

commands, it is recommended to use 

  raw_text {* *}

If you still get errors using "raw_text{* ... *}" the actual LaTeX document
structure generated by Isabelle might be different from the theory structure ...
