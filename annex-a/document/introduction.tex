...
\begin{gather}
  \begin{prooftree}
    \tau 
    % \isasymMathOclValid {\isasymdelta}\ \self \qquad {\tau}\ {\isasymMathOclValid}\ {\isasymupsilon}\ a{\isadigit{1}}
    \justifies
      \isa{{\isasymlbrakk}cp\ E{\isacharsemicolon}
...
\item $\self$ must be defined, the arguments valid in $\tau$:
      $\isasymMathOclValid \isasymMathOclIsDefineds \land \tau \isasymMathOclValid \isasymupsilon~x_1 \land \ldots \land  \tau \isasy~mMathOclValid \isasymupsilon~ x_n$
\end{itemize}
