...
There are cases where strictness is handled differently: For example, since \mocl{Set}'s may contain 
...
overridden operation, the user has to prove Liskov's principle for these situations:
