...
and to point out corner cases.  A \UML class model underlying a
...
\fixme{TODO}
\begin{enumerate}
\item $C$ is a  set of class names (written as $C_1$, \ldots, $C_n$), which
...
\item $Attrib(C_i)$ is a collection of
  attributes associated to classes $C_i$,
