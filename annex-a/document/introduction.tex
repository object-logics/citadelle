...
namely the essence of Set-constructions. The main concern of its construction is 
\emph{consistency}, 
\ie{} it should be possible to apply logical rules and/or evaluation rules for OCL 
in an arbitrary manner always yielding the same result. Moreover, except in 
pathological cases, this result should be unambiquously defined.
Since OCL is a quite complex object-oriented language 
based on a four-valued logics, this effort seems to be justified for a 
