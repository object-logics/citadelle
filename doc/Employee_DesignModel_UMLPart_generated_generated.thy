...
definition "oid14 = 14"
definition "oid15 = 15"
definition "inst_assoc12 = (\<lambda>oid_class to_from oid. ((case (deref_assocs_list ((to_from::oid list list \<Rightarrow> oid list \<times> oid list)) ((oid::oid)) ((drop ((((map_of_list ([(oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0___boss , (List.map ((\<lambda>(x , y). [x , y]) o switch\<^sub>2_01) ([[[oid15] , [oid14]] , [[oid14] , [oid5]] , [[oid12] , [oid13]]])))]))) ((oid_class::oid))))))) of Nil \<Rightarrow> None
    | l \<Rightarrow> (Some (l)))::oid list option))"

(* 146 ************************************ 922 + 8 *)
definition "\<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid12) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0___boss) (switch\<^sub>2_01) (oid12))) (\<lfloor>1000\<rfloor>))"
...
definition "\<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid13) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0___boss) (switch\<^sub>2_01) (oid13))) (\<lfloor>1200\<rfloor>))"
...
definition "\<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid14) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0___boss) (switch\<^sub>2_01) (oid14))) (\<lfloor>2600\<rfloor>))"
...
definition "\<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid15) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0___boss) (switch\<^sub>2_01) (oid15))) (\<lfloor>2300\<rfloor>))"
...
(* 151 ************************************ 934 + 5 *)
axiomatization where dot__contents_def:
"(((\<tau> \<Turnstile> ((\<delta> (self))))) \<Longrightarrow> (\<tau> \<Turnstile> ((\<delta> (((UML_Logic.false)) implies ((((UML_Logic.StrongEq) (result)) ((((UML_Logic.OclIf) (((UML_Logic.StrictRefEq) ((Employee_DesignModel_UMLPart_generated.dot_0___boss) (self))) (UML_Types.null_class.null))) (((UML_Set.OclIncluding) (UML_Set.mtSet)) ((Employee_DesignModel_UMLPart_generated.dot__salary) (self)))) (((UML_Set.OclIncluding) ((Employee_DesignModel_UMLPart_generated.dot__contents) ((Employee_DesignModel_UMLPart_generated.dot_0___boss) (self)))) ((Employee_DesignModel_UMLPart_generated.dot__salary) (self)))) and UML_Logic.true))))))) \<Longrightarrow> ((\<tau> \<Turnstile> (self .contents() \<triangleq> result))) = (if ((\<tau> \<Turnstile> ((\<delta> (self))))) then (\<tau> \<Turnstile> (((UML_Logic.false)) implies ((((UML_Logic.StrongEq) (result)) ((((UML_Logic.OclIf) (((UML_Logic.StrictRefEq) ((Employee_DesignModel_UMLPart_generated.dot_0___boss) (self))) (UML_Types.null_class.null))) (((UML_Set.OclIncluding) (UML_Set.mtSet)) ((Employee_DesignModel_UMLPart_generated.dot__salary) (self)))) (((UML_Set.OclIncluding) ((Employee_DesignModel_UMLPart_generated.dot__contents) ((Employee_DesignModel_UMLPart_generated.dot_0___boss) (self)))) ((Employee_DesignModel_UMLPart_generated.dot__salary) (self)))) and UML_Logic.true)))) else (\<tau> \<Turnstile> (result \<triangleq> invalid)))"
