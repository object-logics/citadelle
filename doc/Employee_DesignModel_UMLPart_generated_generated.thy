theory Employee_DesignModel_UMLPart_generated_generated imports "../src/UML_Main"   "../src/compiler/OCL_compiler_static"   "../src/compiler/OCL_compiler_generator_dynamic" begin
...
(* 116 ************************************ 666 + 15 *)
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<b>\<o>\<s>\<s> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (\<bottom>) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (\<lfloor>x_\<b>\<o>\<s>\<s>\<rfloor>) (_)) \<Rightarrow> (f (x_\<b>\<o>\<s>\<s>)))"
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<s>\<a>\<l>\<a>\<r>\<y> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (\<bottom>)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (\<lfloor>x_\<s>\<a>\<l>\<a>\<r>\<y>\<rfloor>)) \<Rightarrow> (f (x_\<s>\<a>\<l>\<a>\<r>\<y>)))"
definition "select\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t\<w>\<o>\<r>\<m>\<h>\<o>\<l>\<e> f = (\<lambda> (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (\<bottom>) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (\<lfloor>x_\<w>\<o>\<r>\<m>\<h>\<o>\<l>\<e>\<rfloor>) (_)) \<Rightarrow> (f (x_\<w>\<o>\<r>\<m>\<h>\<o>\<l>\<e>)))"
definition "select\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t\<w>\<e>\<i>\<g>\<h>\<t> f = (\<lambda> (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (_) (\<bottom>)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (_) (\<lfloor>x_\<w>\<e>\<i>\<g>\<h>\<t>\<rfloor>)) \<Rightarrow> (f (x_\<w>\<e>\<i>\<g>\<h>\<t>)))"
definition "select\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y\<s>\<o>\<u>\<n>\<d> f = (\<lambda> (mk\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y (_) (\<bottom>) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y (_) (\<lfloor>x_\<s>\<o>\<u>\<n>\<d>\<rfloor>) (_) (_)) \<Rightarrow> (f (x_\<s>\<o>\<u>\<n>\<d>)))"
definition "select\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y\<m>\<o>\<v>\<i>\<n>\<g> f = (\<lambda> (mk\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y (_) (_) (\<bottom>) (_)) \<Rightarrow> null
    | (mk\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y (_) (_) (\<lfloor>x_\<m>\<o>\<v>\<i>\<n>\<g>\<rfloor>) (_)) \<Rightarrow> (f (x_\<m>\<o>\<v>\<i>\<n>\<g>)))"
definition "select\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d> f = (\<lambda> (mk\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y (_) (_) (_) (\<bottom>)) \<Rightarrow> null
    | (mk\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y (_) (_) (_) (\<lfloor>x_\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d>\<rfloor>)) \<Rightarrow> (f (x_\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d>)))"
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<w>\<o>\<r>\<m>\<h>\<o>\<l>\<e> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (\<bottom>) (_) (_) (_) (_))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (\<lfloor>x_\<w>\<o>\<r>\<m>\<h>\<o>\<l>\<e>\<rfloor>) (_) (_) (_) (_))) (_) (_)) \<Rightarrow> (f (x_\<w>\<o>\<r>\<m>\<h>\<o>\<l>\<e>)))"
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<w>\<e>\<i>\<g>\<h>\<t> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (\<bottom>) (_) (_) (_))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (\<lfloor>x_\<w>\<e>\<i>\<g>\<h>\<t>\<rfloor>) (_) (_) (_))) (_) (_)) \<Rightarrow> (f (x_\<w>\<e>\<i>\<g>\<h>\<t>)))"
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<s>\<o>\<u>\<n>\<d> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (_) (\<bottom>) (_) (_))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (_) (\<lfloor>x_\<s>\<o>\<u>\<n>\<d>\<rfloor>) (_) (_))) (_) (_)) \<Rightarrow> (f (x_\<s>\<o>\<u>\<n>\<d>)))"
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<m>\<o>\<v>\<i>\<n>\<g> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (_) (_) (\<bottom>) (_))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (_) (_) (\<lfloor>x_\<m>\<o>\<v>\<i>\<n>\<g>\<rfloor>) (_))) (_) (_)) \<Rightarrow> (f (x_\<m>\<o>\<v>\<i>\<n>\<g>)))"
definition "select\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d> f = (\<lambda> (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (_) (_) (_) (\<bottom>))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (_) (_) (_) (_) (_) (\<lfloor>x_\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d>\<rfloor>))) (_) (_)) \<Rightarrow> (f (x_\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d>)))"
definition "select\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t\<s>\<o>\<u>\<n>\<d> f = (\<lambda> (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t ((mk\<E>\<X>\<T>\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (\<bottom>) (_) (_))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t ((mk\<E>\<X>\<T>\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (\<lfloor>x_\<s>\<o>\<u>\<n>\<d>\<rfloor>) (_) (_))) (_) (_)) \<Rightarrow> (f (x_\<s>\<o>\<u>\<n>\<d>))
...
definition "select\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t\<m>\<o>\<v>\<i>\<n>\<g> f = (\<lambda> (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t ((mk\<E>\<X>\<T>\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (_) (\<bottom>) (_))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t ((mk\<E>\<X>\<T>\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (_) (\<lfloor>x_\<m>\<o>\<v>\<i>\<n>\<g>\<rfloor>) (_))) (_) (_)) \<Rightarrow> (f (x_\<m>\<o>\<v>\<i>\<n>\<g>))
...
definition "select\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d> f = (\<lambda> (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t ((mk\<E>\<X>\<T>\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (_) (_) (\<bottom>))) (_) (_)) \<Rightarrow> null
    | (mk\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t ((mk\<E>\<X>\<T>\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t (_) (_) (_) (\<lfloor>x_\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d>\<rfloor>))) (_) (_)) \<Rightarrow> (f (x_\<o>\<u>\<t>\<e>\<r>095\<w>\<o>\<r>\<l>\<d>))
...
(* 135 ************************************ 858 + 2 *)
definition "(typecheck_instance_bad_head_on_lhs\<^sub>P\<^sub>1\<^sub>_\<^sub>X\<^sub>0\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>9\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>8\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>7\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>6\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>5\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>4\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>3\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>2\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>1 (P1) (X0) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2) (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1)) = ()"
definition "typecheck_instance_extra_variables_on_rhs\<^sub>P\<^sub>1\<^sub>_\<^sub>X\<^sub>0\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>9\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>8\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>7\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>6\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>5\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>4\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>3\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>2\<^sub>_\<^sub>X092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>P092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>e092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>r092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>s092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>o092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>n\<^sub>1 = (\<lambda>P1 X0 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2 X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1. (P1 , P1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2))"
...
(* 137 ************************************ 872 + 22 *)
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid1) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid1))) (\<lfloor>1300\<rfloor>))"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid2) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid2))) (\<lfloor>1800\<rfloor>))"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid3) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid3))) (None))"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid4) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid4))) (\<lfloor>2900\<rfloor>))"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid5) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid5))) (\<lfloor>3500\<rfloor>))"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid6) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid6))) (\<lfloor>2500\<rfloor>))"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y inst_assoc = (mk\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y ((mk\<E>\<X>\<T>\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid7) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid7))) (\<lfloor>3200\<rfloor>))))))"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7::\<cdot>OclAny) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y (inst_assoc1))\<rfloor>\<rfloor>)"
...
definition "X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid9) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid9))) (\<lfloor>0\<rfloor>))"
...
definition "X0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid10) (None) (None) (None) (None) (\<lfloor>[[oid11]]\<rfloor>))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid10))) (None))"
...
(* 139 ************************************ 895 + 2 *)
definition "(typecheck_instance_bad_head_on_lhs092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>4\<^sub>_092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>2\<^sub>_092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>1\<^sub>_092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>0 (\<sigma>\<^sub>1_object4) (\<sigma>\<^sub>1_object2) (\<sigma>\<^sub>1_object1) (\<sigma>\<^sub>1_object0)) = ()"
definition "typecheck_instance_extra_variables_on_rhs092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>4\<^sub>_092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>2\<^sub>_092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>1\<^sub>_092060\<^sub>s\<^sub>i\<^sub>g\<^sub>m\<^sub>a062092060094\<^sub>s\<^sub>u\<^sub>b062\<^sub>1\<^sub>_\<^sub>o\<^sub>b\<^sub>j\<^sub>e\<^sub>c\<^sub>t\<^sub>0 = (\<lambda>\<sigma>\<^sub>1_object4 \<sigma>\<^sub>1_object2 \<sigma>\<^sub>1_object1 \<sigma>\<^sub>1_object0. (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5))"
...
definition "oid14 = 14"
definition "oid15 = 15"
definition "inst_assoc12 = (\<lambda>oid_class to_from oid. ((case (deref_assocs_list ((to_from::oid list list \<Rightarrow> oid list \<times> oid list)) ((oid::oid)) ((drop ((((map_of_list ([(oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s> , (List.map ((\<lambda>(x , y). [x , y]) o switch\<^sub>2_01) ([[[oid15] , [oid14]] , [[oid14] , [oid5]] , [[oid12] , [oid13]]])))]))) ((oid_class::oid))))))) of Nil \<Rightarrow> None
    | l \<Rightarrow> (Some (l)))::oid list option))"

(* 141 ************************************ 902 + 8 *)
definition "\<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid12) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid12))) (\<lfloor>1000\<rfloor>))"
...
definition "\<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid13) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid13))) (\<lfloor>1200\<rfloor>))"
...
definition "\<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid14) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid14))) (\<lfloor>2600\<rfloor>))"
...
definition "\<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n inst_assoc = (mk\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((mk\<E>\<X>\<T>\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (oid15) (None) (None) (None) (None) (None))) (((inst_assoc) (oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s>) (switch\<^sub>2_01) (oid15))) (\<lfloor>2300\<rfloor>))"
...
(* 143 ************************************ 911 + 1 *)
definition "inst_assoc\<sigma>\<^sub>1 = (\<lambda>oid_class to_from oid. ((case (deref_assocs_list ((to_from::oid list list \<Rightarrow> oid list \<times> oid list)) ((oid::oid)) ((drop ((((map_of_list ([(oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s> , (List.map ((\<lambda>(x , y). [x , y]) o switch\<^sub>2_01) ([[[oid15] , [oid3]] , [[oid14] , [oid4]] , [[oid12] , [oid2]]])))]))) ((oid_class::oid))))))) of Nil \<Rightarrow> None
    | l \<Rightarrow> (Some (l)))::oid list option))"

(* 144 ************************************ 912 + 1 *)
definition "\<sigma>\<^sub>1 = (state.make ((Map.empty (oid12 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid13 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid14 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid5 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid15 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid9 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))))) (Map.empty))"

(* 145 ************************************ 913 + 6 *)
definition "(\<sigma>\<^sub>1_object0\<sigma>\<^sub>1::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(\<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))\<rfloor>\<rfloor>)"
definition "(\<sigma>\<^sub>1_object1\<sigma>\<^sub>1::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(\<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))\<rfloor>\<rfloor>)"
definition "(\<sigma>\<^sub>1_object2\<sigma>\<^sub>1::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(\<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))\<rfloor>\<rfloor>)"
definition "(\<sigma>\<^sub>1_object4\<sigma>\<^sub>1::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(\<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))\<rfloor>\<rfloor>)"
...
(* 148 ************************************ 921 + 1 *)
lemma perm_\<sigma>\<^sub>1 : "\<sigma>\<^sub>1 = (state.make ((Map.empty (oid9 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid15 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid5 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid14 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid13 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))) (oid12 \<mapsto> (in\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n ((\<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1))))))) ((assocs (\<sigma>\<^sub>1))))"
  apply(simp add: \<sigma>\<^sub>1_def oid12_def oid13_def oid14_def oid5_def oid15_def oid9_def)
...
shows "(mk (\<sigma>\<^sub>1)) \<Turnstile> (OclAllInstances_generic (pre_post) (Person)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1}"
  apply(subst perm_\<sigma>\<^sub>1)
  apply(simp only: state.make_def oid12_def oid13_def oid14_def oid5_def oid15_def oid9_def \<sigma>\<^sub>1_object0\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object1\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object2\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object4\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1_def)
...
shows "(st , \<sigma>\<^sub>1) \<Turnstile> (OclAllInstances_at_post (Person)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1}"
  unfolding OclAllInstances_at_post_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_Person, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_at_pre_exec_Person : 
shows "(\<sigma>\<^sub>1 , st) \<Turnstile> (OclAllInstances_at_pre (Person)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1}"
  unfolding OclAllInstances_at_pre_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_Person, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_generic_exec_Planet : 
assumes [simp]: "(\<And>a. (pre_post ((mk (a)))) = a)"
shows "(mk (\<sigma>\<^sub>1)) \<Turnstile> (OclAllInstances_generic (pre_post) (Planet)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(Planet) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(Planet) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(Planet)}"
  apply(subst perm_\<sigma>\<^sub>1)
  apply(simp only: state.make_def oid12_def oid13_def oid14_def oid5_def oid15_def oid9_def \<sigma>\<^sub>1_object0\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object1\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object2\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object4\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def)
...
shows "(st , \<sigma>\<^sub>1) \<Turnstile> (OclAllInstances_at_post (Planet)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(Planet) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(Planet) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(Planet)}"
  unfolding OclAllInstances_at_post_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_Planet, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_at_pre_exec_Planet : 
shows "(\<sigma>\<^sub>1 , st) \<Turnstile> (OclAllInstances_at_pre (Planet)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(Planet) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(Planet) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(Planet) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(Planet)}"
  unfolding OclAllInstances_at_pre_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_Planet, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_generic_exec_Galaxy : 
assumes [simp]: "(\<And>a. (pre_post ((mk (a)))) = a)"
shows "(mk (\<sigma>\<^sub>1)) \<Turnstile> (OclAllInstances_generic (pre_post) (Galaxy)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(Galaxy) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(Galaxy) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(Galaxy)}"
  apply(subst perm_\<sigma>\<^sub>1)
  apply(simp only: state.make_def oid12_def oid13_def oid14_def oid5_def oid15_def oid9_def \<sigma>\<^sub>1_object0\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object1\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object2\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object4\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def)
...
shows "(st , \<sigma>\<^sub>1) \<Turnstile> (OclAllInstances_at_post (Galaxy)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(Galaxy) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(Galaxy) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(Galaxy)}"
  unfolding OclAllInstances_at_post_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_Galaxy, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_at_pre_exec_Galaxy : 
shows "(\<sigma>\<^sub>1 , st) \<Turnstile> (OclAllInstances_at_pre (Galaxy)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(Galaxy) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(Galaxy) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(Galaxy) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(Galaxy)}"
  unfolding OclAllInstances_at_pre_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_Galaxy, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_generic_exec_OclAny : 
assumes [simp]: "(\<And>a. (pre_post ((mk (a)))) = a)"
shows "(mk (\<sigma>\<^sub>1)) \<Turnstile> (OclAllInstances_generic (pre_post) (OclAny)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(OclAny) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(OclAny) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(OclAny)}"
  apply(subst perm_\<sigma>\<^sub>1)
  apply(simp only: state.make_def oid12_def oid13_def oid14_def oid5_def oid15_def oid9_def \<sigma>\<^sub>1_object0\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object1\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object2\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object4\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def)
...
shows "(st , \<sigma>\<^sub>1) \<Turnstile> (OclAllInstances_at_post (OclAny)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(OclAny) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(OclAny) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(OclAny)}"
  unfolding OclAllInstances_at_post_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_OclAny, simp) 
lemma \<sigma>\<^sub>1_OclAllInstances_at_pre_exec_OclAny : 
shows "(\<sigma>\<^sub>1 , st) \<Turnstile> (OclAllInstances_at_pre (OclAny)) \<doteq> Set{\<sigma>\<^sub>1_object0\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object1\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object2\<sigma>\<^sub>1 .oclAsType(OclAny) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1 .oclAsType(OclAny) , \<sigma>\<^sub>1_object4\<sigma>\<^sub>1 .oclAsType(OclAny) , X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1 .oclAsType(OclAny)}"
  unfolding OclAllInstances_at_pre_def
by(rule \<sigma>\<^sub>1_OclAllInstances_generic_exec_OclAny, simp) 
...
(* 151 ************************************ 935 + 1 *)
definition "inst_assoc\<sigma>\<^sub>1' = (\<lambda>oid_class to_from oid. ((case (deref_assocs_list ((to_from::oid list list \<Rightarrow> oid list \<times> oid list)) ((oid::oid)) ((drop ((((map_of_list ([(oid\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_0_\<b>\<o>\<s>\<s> , (List.map ((\<lambda>(x , y). [x , y]) o switch\<^sub>2_01) ([[[oid7] , [oid6]] , [[oid6] , [oid6]] , [[oid2] , [oid2]] , [[oid1] , [oid2]]])))]))) ((oid_class::oid))))))) of Nil \<Rightarrow> None
    | l \<Rightarrow> (Some (l)))::oid list option))"
...
(* 153 ************************************ 937 + 8 *)
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<sigma>\<^sub>1'::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<sigma>\<^sub>1'::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3\<sigma>\<^sub>1'::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<sigma>\<^sub>1'::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<sigma>\<^sub>1'::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<sigma>\<^sub>1'::\<cdot>OclAny) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8\<sigma>\<^sub>1'::\<cdot>OclAny) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
definition "(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1'::\<cdot>Person) = (\<lambda>_. \<lfloor>\<lfloor>(X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n (inst_assoc\<sigma>\<^sub>1'))\<rfloor>\<rfloor>)"
...
by(simp add: WFF_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_\<AA>_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def \<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)

(* 160 ************************************ 962 + 14 *)
lemma oid1\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1'_OclIsNew : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsNew (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<sigma>\<^sub>1'))"
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid2\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1'_OclIsNew : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsNew (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<sigma>\<^sub>1'))"
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
...
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n3\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid4\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1'_OclIsNew : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsNew (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<sigma>\<^sub>1'))"
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
...
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n5\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsDeleted_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid6\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1'_OclIsNew : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsNew (X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<sigma>\<^sub>1'))"
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n6\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
...
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n7\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
...
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n8\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def OclIsNew_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
...
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsMaintained_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
...
by(simp add: X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<sigma>\<^sub>1'_def X\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n9\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsMaintained_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid12\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1_OclIsDeleted : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsDeleted (\<sigma>\<^sub>1_object0\<sigma>\<^sub>1))"
by(simp add: \<sigma>\<^sub>1_object0\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object0\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsDeleted_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid13\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1_OclIsDeleted : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsDeleted (\<sigma>\<^sub>1_object1\<sigma>\<^sub>1))"
by(simp add: \<sigma>\<^sub>1_object1\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object1\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsDeleted_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid14\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1_OclIsDeleted : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsDeleted (\<sigma>\<^sub>1_object2\<sigma>\<^sub>1))"
by(simp add: \<sigma>\<^sub>1_object2\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object2\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsDeleted_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)
lemma oid15\<sigma>\<^sub>1\<sigma>\<^sub>1'_\<sigma>\<^sub>1_OclIsDeleted : "(\<sigma>\<^sub>1 , \<sigma>\<^sub>1') \<Turnstile> (OclIsDeleted (\<sigma>\<^sub>1_object4\<sigma>\<^sub>1))"
by(simp add: \<sigma>\<^sub>1_object4\<sigma>\<^sub>1_def \<sigma>\<^sub>1_object4\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def OclIsDeleted_def OclValid_def \<sigma>\<^sub>1_def \<sigma>\<^sub>1'_def oid_of_option_def oid1_def oid2_def oid3_def oid4_def oid5_def oid6_def oid7_def oid8_def oid9_def oid12_def oid13_def oid14_def oid15_def oid_of_ty\<^sub>P\<^sub>e\<^sub>r\<^sub>s\<^sub>o\<^sub>n_def oid_of_ty\<^sub>P\<^sub>l\<^sub>a\<^sub>n\<^sub>e\<^sub>t_def oid_of_ty\<^sub>G\<^sub>a\<^sub>l\<^sub>a\<^sub>x\<^sub>y_def oid_of_ty\<^sub>O\<^sub>c\<^sub>l\<^sub>A\<^sub>n\<^sub>y_def)

(* 161 ************************************ 976 + 5 *)
axiomatization where dot\<c>\<o>\<n>\<t>\<e>\<n>\<t>\<s>_def:
"(((\<tau> \<Turnstile> ((\<delta> (self))))) \<Longrightarrow> (\<tau> \<Turnstile> ((\<delta> (((UML_Logic.false)) implies ((((UML_Logic.StrongEq) (result)) ((((UML_Logic.OclIf) (((UML_Logic.StrictRefEq) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>) (self))) (UML_Types.null_class.null))) (((UML_Set.OclIncluding) (UML_Set.mtSet)) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>) (self)))) (((UML_Set.OclIncluding) ((Employee_DesignModel_UMLPart_generated.dot\<c>\<o>\<n>\<t>\<e>\<n>\<t>\<s>) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>) (self)))) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>) (self)))) and UML_Logic.true))))))) \<Longrightarrow> ((\<tau> \<Turnstile> (self .contents() \<triangleq> result))) = (if ((\<tau> \<Turnstile> ((\<delta> (self))))) then (\<tau> \<Turnstile> (((UML_Logic.false)) implies ((((UML_Logic.StrongEq) (result)) ((((UML_Logic.OclIf) (((UML_Logic.StrictRefEq) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>) (self))) (UML_Types.null_class.null))) (((UML_Set.OclIncluding) (UML_Set.mtSet)) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>) (self)))) (((UML_Set.OclIncluding) ((Employee_DesignModel_UMLPart_generated.dot\<c>\<o>\<n>\<t>\<e>\<n>\<t>\<s>) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>) (self)))) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>) (self)))) and UML_Logic.true)))) else (\<tau> \<Turnstile> (result \<triangleq> invalid)))"
defs(overloaded) dot\<c>\<o>\<n>\<t>\<e>\<n>\<t>\<s>_Planet : "(x::\<cdot>Planet) .contents() \<equiv> x .oclAsType(Person) .contents()"
defs(overloaded) dot\<c>\<o>\<n>\<t>\<e>\<n>\<t>\<s>_Galaxy : "(x::\<cdot>Galaxy) .contents() \<equiv> x .oclAsType(Person) .contents()"
defs(overloaded) dot\<c>\<o>\<n>\<t>\<e>\<n>\<t>\<s>_OclAny : "(x::\<cdot>OclAny) .contents() \<equiv> x .oclAsType(Person) .contents()"
ML{* (Ty'.check ([]) (" error(s)")) *}
...
(* 165 ************************************ 982 + 3 *)
axiomatization where Person_aat_pre_def:
"(\<tau> \<Turnstile> (UML_Set.OclForall ((OclAllInstances_at_pre (Person))) ((\<lambda>self. ((UML_Logic.OclImplies) ((UML_Logic.OclNot) (((UML_Logic.StrictRefEq) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>at_pre) (self))) (UML_Types.null_class.null)))) (((UML_Logic.StrongEq) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>at_pre) (self))) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>at_pre) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>at_pre) (self))))))))"
axiomatization where Person_a_def:
"(\<tau> \<Turnstile> (UML_Set.OclForall ((OclAllInstances_at_post (Person))) ((\<lambda>self. ((UML_Logic.OclImplies) ((UML_Logic.OclNot) (((UML_Logic.StrictRefEq) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>) (self))) (UML_Types.null_class.null)))) (((UML_Logic.StrongEq) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>) (self))) ((Employee_DesignModel_UMLPart_generated.dot\<s>\<a>\<l>\<a>\<r>\<y>) ((Employee_DesignModel_UMLPart_generated.dot_0_\<b>\<o>\<s>\<s>) (self))))))))"
ML{* (Ty'.check ([]) (" error(s)")) *}
...
(* 168 ************************************ 986 + 3 *)
axiomatization where Planet_Aat_pre_def:
"(\<tau> \<Turnstile> (UML_Set.OclForall ((OclAllInstances_at_pre (Planet))) ((\<lambda>self. ((UML_Logic.OclAnd) (UML_Logic.true)) (((UML_Integer.OclLe\<^sub>I\<^sub>n\<^sub>t\<^sub>e\<^sub>g\<^sub>e\<^sub>r) ((Employee_DesignModel_UMLPart_generated.dot\<w>\<e>\<i>\<g>\<h>\<t>at_pre) (self))) (UML_Integer.OclInt0))))))"
axiomatization where Planet_A_def:
"(\<tau> \<Turnstile> (UML_Set.OclForall ((OclAllInstances_at_post (Planet))) ((\<lambda>self. ((UML_Logic.OclAnd) (UML_Logic.true)) (((UML_Integer.OclLe\<^sub>I\<^sub>n\<^sub>t\<^sub>e\<^sub>g\<^sub>e\<^sub>r) ((Employee_DesignModel_UMLPart_generated.dot\<w>\<e>\<i>\<g>\<h>\<t>) (self))) (UML_Integer.OclInt0))))))"
ML{* (Ty'.check ([]) (" error(s)")) *}
