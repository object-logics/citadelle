...
(* 135 ************************************ 1792 + 2 *)
definition "(typecheck_instance_bad_head_on_lhs\<^sub>B\<^sub>a\<^sub>n\<^sub>k\<^sub>1\<^sub>_\<^sub>A\<^sub>c\<^sub>c\<^sub>o\<^sub>u\<^sub>n\<^sub>t\<^sub>1\<^sub>_\<^sub>C\<^sub>l\<^sub>i\<^sub>e\<^sub>n\<^sub>t\<^sub>1\<^sub>_\<^sub>S\<^sub>a\<^sub>v\<^sub>i\<^sub>n\<^sub>g\<^sub>1 (Bank1) (Account1) (Client1) (Saving1)) = ()"
definition "typecheck_instance_extra_variables_on_rhs\<^sub>B\<^sub>a\<^sub>n\<^sub>k\<^sub>1\<^sub>_\<^sub>A\<^sub>c\<^sub>c\<^sub>o\<^sub>u\<^sub>n\<^sub>t\<^sub>1\<^sub>_\<^sub>C\<^sub>l\<^sub>i\<^sub>e\<^sub>n\<^sub>t\<^sub>1\<^sub>_\<^sub>S\<^sub>a\<^sub>v\<^sub>i\<^sub>n\<^sub>g\<^sub>1 = (\<lambda>Bank1 Account1 Client1 Saving1. (Account1 , Saving1 , Client1 , Bank1 , Saving1))"
...
(* 138 ************************************ 1806 + 1 *)
ML{* (Ty'.check ([(OCL.Writeln , "Saving1 .owner \<cong> Set{ Client1 }") , (OCL.Writeln , "Saving1 .bank \<cong> Set{ Bank1 }") , (OCL.Writeln , "Client1 .banks \<cong> Set{ Bank1 }") , (OCL.Writeln , "Client1 .c_accounts \<cong> Set{ Saving1 , Account1 }") , (OCL.Writeln , "Account1 .owner \<cong> Set{ Client1 }") , (OCL.Writeln , "Account1 .bank \<cong> Set{ Bank1 }") , (OCL.Writeln , "Bank1 .clients \<cong> Set{ Client1 }") , (OCL.Writeln , "Bank1 .b_accounts \<cong> Set{ Saving1 , Account1 }")]) (" error(s)")) *}
...
(* 141 ************************************ 1811 + 1 *)
definition "(typecheck_state_bad_head_on_lhs\<^sub>s\<^sub>s (ss)) = ()"
